 ...
 *
 * <p>Implementations must tolerate nested folder structures and must skip entries without a usable
 * method or URL. The file format (JSON or YAML) is detected by the implementation.
 */
