...
public final class EndpointCoverageToolWindowFactory implements ToolWindowFactory, DumbAware {
  ...
  public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
    ...
    Content content =
        ContentFactory.getInstance().createContent(new CoveragePanel(project), "", false);
   ...
   */
  @Override
  public @Nullable Object isApplicableAsync(
    ...
    try {
      ...
      LOG.warn(
          "Failed to check whether the project has Java modules; showing the tool window anyway",
          brokenPlatform);
      return Boolean.TRUE;
    }
  }
