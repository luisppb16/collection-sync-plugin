 ...
 *
 * <ul>
 *   <li><b>isController:</b> the class carries {@code @Path}.</li>
 *   <li><b>basePath:</b> {@code value} of the class-level {@code @Path}, or {@code ""} when absent
 *   (cannot happen for a class accepted by {@link #isController(PsiClass)}).</li>
 *   <li><b>methods:</b> {@code @GET}, {@code @POST}, {@code @PUT}, {@code @DELETE},
 *   {@code @PATCH}, {@code @HEAD} and {@code @OPTIONS} each declare one fixed HTTP method.</li>
...
public final class JaxRsAnnotationResolver implements EndpointAnnotationResolver {
    ...
    private static final List<FixedMethod> FIXED_METHODS = List.of(
