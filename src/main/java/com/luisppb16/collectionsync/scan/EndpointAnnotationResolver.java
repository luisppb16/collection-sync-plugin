...
/**
 * Extracts endpoints from annotated controller methods for one specific framework
 * (Spring MVC, JAX-RS...). One implementation per framework, selected by a detector.
 */
